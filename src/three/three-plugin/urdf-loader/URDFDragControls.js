...
export class PointerURDFDragControls extends URDFDragControls {
    ...
    constructor(scene, camera, domElement) {
        ...
        function updateMouse(e) {
            // 修改为非全屏情况适配
            mouse.x = ((e.clientX - domElement.getBoundingClientRect().left) / domElement.offsetWidth) * 2 - 1;
            mouse.y = -((e.clientY - domElement.getBoundingClientRect().top) / domElement.offsetHeight) * 2 + 1;
        }
