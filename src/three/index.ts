...
import { FontLoader } from '@/three/three-plugin/jsm/loaders/FontLoader';
import { TextGeometry } from '@/three/three-plugin/jsm/geometries/TextGeometry';
export default class ThreeJs {
  ...
  setCube(): void {
    if (this.scene) {
      ...
      const texture = new THREE.TextureLoader().load('/assets/imgs/wps.jpg'); //首先，获取到纹理
